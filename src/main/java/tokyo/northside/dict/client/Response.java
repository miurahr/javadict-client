...
import tokyo.northside.dict.exceptions.NoSuchResponseException;
import tokyo.northside.dict.exceptions.StatusException;
import tokyo.northside.dict.exceptions.TooManyResponsesException;
...
public class Response {
    ...
    private final ArrayList<SingleResponse> responses = new ArrayList<>();
    ...
    public ArrayList<? extends SingleResponse> getResponses(int statusCode) {
        ArrayList<SingleResponse> nuList = new ArrayList<>();
