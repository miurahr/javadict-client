...
public class DictURLConnection extends java.net.URLConnection {
    ...
    private byte[] getBody() throws IOException {
        if (body == null) {
            try {
                ...
                if(authType != null) {
                    PasswordAuthentication pa = Authenticator.requestPasswordAuthentication(host, null, port, "dict", "Enter shared secret", "scheme");
                    if ( pa == null) {
    ...
    private void setMethod(java.lang.String method) {
        if(!method.startsWith("/")) throw new RuntimeException("Invalid method");
